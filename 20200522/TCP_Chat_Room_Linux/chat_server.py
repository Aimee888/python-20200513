...
# -*- coding: UTF-8 -*-
"""=================================================
@Project -> File   ：six-dialog_design -> chat_server
@IDE    ：PyCharm
@Author ：zihan
@Date   ：2020/5/22 22:21
@Desc   ：https://www.cnblogs.com/noonjuan/p/11295438.html
@version : 0.0.0.1 --> 2020/5/22 --> Windows下执行select(rlist, wlist, xlist)会报错，因为windows下的select函数只认socket
=================================================="""
# 导入系统模块
import os, sys
# 导入网络编程（传输层）模块
